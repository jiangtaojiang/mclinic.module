...
<openmrs:require privilege="Manage Mclinic" otherwise="/login.htm" redirect="/module/mclinic/concept/manageConcept.form"/>
	...
	$j(document).ready(function () {
		...
		$j("#searchConcept").autocomplete({
			source:function (request, response) {
				jQuery.ajax({
					url:"${pageContext.request.contextPath}/module/mclinic/search/concept.form",
					dataType:"json",
					data:{
